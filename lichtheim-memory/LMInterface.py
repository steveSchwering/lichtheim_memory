...
if __name__ == '__main__':
    ...
    word = 'man'
    word_patterns = interface.generate_weighted_tasks_for_utterance(utterance = [word])

    # Single sentence example
    sentence_lst = ['man', 'gave', 'boy', 'tea']
    sentence_patterns = interface.generate_weighted_tasks_for_utterance(utterance = sentence_lst)

    # Generate artificial words
    artificial_words = interface.generate_all_artificial_words(num_phones = 4)
    print(artificial_words)